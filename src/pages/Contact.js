        ...
        return (
            <>
                ...
                <form
                    ...
                    action={`https://quotes-php.herokuapp.com/api/POST/mail.php`}
                    method="post"
                >
                    <label>
                        Powód wiadomości:
                        ...
                        >
                            <option value="1">
                                Chciałbym zgłosić propozycję nowego cytatu
                            </option>
                            <option value="2">
                                Chciałbym zgłosić błąd w aplikacji
                            </option>
                            <option value="3">
                                Chciałbym skontaktować się z administratorem
                            </option>
                        </select>
                    </label>
                    ...
                    <button className={this.state.load ? 'load' : ''}>
                        WYŚLIJ
                        <i className="icon-spin2" />
                    </button>
                </form>
            </>
        );
